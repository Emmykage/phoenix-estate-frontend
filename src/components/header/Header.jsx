...
const Header = ({user}) => {
  ...
  return (
    ...
    <div className="container">
      ...
      {/* <!-- main menu --> */}
      <nav className={`${stickyNav} bg-white navbar navbar-expand-lg navbar-light  bg- p-0`}>
      <button className="navbar-toggler" type="button" onClick={() => show == "collapse" ?  setShow("null") : setShow('collapse')}>
